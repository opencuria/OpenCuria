...
@pytest.mark.django_db(transaction=True)
def test_agent_s_config_migration_0018_adds_recording_default_off(
    agent_s_setup,
) -> None:
    """Migration 0018 state adds enable_recording with default False."""
    import importlib

    migration = importlib.import_module(
        "apps.harness.migrations.0018_agentsconfig_recording"
    )
    ...
    assert migration.Migration.dependencies == [("harness", "0017_agentsconfig")]
